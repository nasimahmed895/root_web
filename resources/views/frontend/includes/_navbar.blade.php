                    ...
                    <li class="nav-item dropdown p-0">
                        ...
                        <ul class="dropdown-menu">
                            <li class="{{ request()->routeIs('dedicated_team') ? 'active' : '' }}"><a
                                    class="dropdown-item " href="{{ route('dedicated_team') }}">HIRE DEDICATE TEAM</a>
                            </li>
                            <hr>
                            <li class="{{ request()->routeIs('project_base') ? 'active' : '' }}"><a
                                    class="dropdown-item " href="{{ route('project_base') }}">PROJECT BASED</a></li>
                            <hr class="hidden-hr">
                        </ul>
                    </li>
                    <li class="nav-item">
