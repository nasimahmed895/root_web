...
try {
    ...
    $(document).ready(function () {
        ...
        $(".demo").slick({
            prevArrow:
                "<img class='a-left control-c prev slick-prev' src='public/frontend/Icon_Images/left.png'>",
            nextArrow:
                "<img class='a-right control-c next slick-next' src='public/frontend/Icon_Images/right.png'>",
            infinite: true,
            speed: 300,
            slidesToShow: 3,
            slidesToScroll: 1,
    ...
    for (var i = 0; i < itemsId.length; i++) {
        // @ts-ignore
        itemsId[i].style.top =
            radiusLength * Math.sin(radianSectionDeg * i - 5.215) - 50 + "px";
        // @ts-ignore
        itemsId[i].style.left =
            radiusLength * Math.cos(radianSectionDeg * i - 5.22) - 50 + "px";
    }
    ...
    for (var i = 0; i < itemsId2.length; i++) {
        // @ts-ignore
        itemsId2[i].style.top =
            radiusLength2 * Math.sin(radianSectionDeg2 * i - 2.12) - 50 + "px";
        // @ts-ignore
        itemsId2[i].style.left =
            radiusLength2 * Math.cos(radianSectionDeg2 * i - 2.12) - 50 + "px";
    }
